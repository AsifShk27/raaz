...
description: Order or manage Swiggy food delivery in India via the Clawdbot browser. Use for searching restaurants or dishes, building a cart with item options, applying offers, checking out, and tracking orders. Never place or pay for an order without explicit user confirmation.
---
...
Use the Clawdbot-controlled browser to help the user order food on Swiggy: set location, pick restaurants, add items and modifiers, and track orders. Always ask for confirmation before clicking any final place order or pay action.
...
1. Start browser and open Swiggy
   - `clawdbot browser start`
   - `clawdbot browser open https://www.swiggy.com/`
...
- If the site fails to load in headless mode, try non-headless Chrome or a non-snap Chrome build. See `docs/tools/browser-linux-troubleshooting.md`.
